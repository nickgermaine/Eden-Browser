...
namespace eden::core {
    ...
    class TabModel final : public QAbstractListModel {
      ...
      public:
        ...
        using ViewFactory =
            std::function<std::unique_ptr<engine::EngineView>(engine::Backend backend, engine::EngineProfile *profile)>;
        using ProfileResolver = std::function<std::shared_ptr<engine::EngineProfile>(engine::Backend backend)>;
        using ConversionGate = std::function<void(
        ...
        void setConversionGate(ConversionGate gate);
        const QString &profileToken() const;

        int rowCount(const QModelIndex &parent = {}) const override;
        QVariant data(const QModelIndex &index, int role) const override;
        QHash<int, QByteArray> roleNames() const override;

        Q_INVOKABLE int addTab(const QUrl &url = {}, bool background = false, const QString &backendId = {});
        ...
        int openWithTab(const QUrl &url, const QString &backendId, int sourceIndex);
      ...
      private:
        ...
        ConversionGate m_conversionGate;
