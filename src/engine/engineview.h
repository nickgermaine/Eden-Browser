...
class EngineView : public QObject {
    ...
    Q_PROPERTY(DevToolsPlacement devToolsPlacement READ devToolsPlacement WRITE setDevToolsPlacement NOTIFY devToolsPlacementChanged)
  ...
  public:
    ...
    enum Capability { DockedDevtools = 0x1, HistorySerialization = 0x2, ThumbnailCapture = 0x4, OsrCompositing = 0x8, PerTabMute = 0x10 };
